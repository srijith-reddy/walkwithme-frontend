...
final class TurnHUDManager {
    ...
    // --------------------------------------------------------
    // Public API expected by ARSessionManager
    // Allows nil to hide the panel.
    // --------------------------------------------------------
    func updateTurn(instruction: String?, distanceMeters: Double?) {
        guard let instruction, let distanceMeters else {
            hide()
            return
        }
        show()
    ...
    // --------------------------------------------------------
    // UPDATE turn instruction (non-optional internal)
    // --------------------------------------------------------
