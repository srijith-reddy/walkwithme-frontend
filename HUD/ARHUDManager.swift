...
final class ARHUDManager: NSObject {
    ...
    private var miniMapStyle: MiniMapStyle = .circleRight
    ...
    func updateCompass(heading: CLLocationDirection) {
        // The minimap already rotates with user heading, so a second
        // floating compass in the top-left is redundant clutter in AR.
    }
    ...
    private func applyMiniMapLayout() {
        ...
        case .circleRight:
            // Small floating circle on bottom-right
            ...
            miniMapBottomConstraint?.constant = -96
            miniMapBottomConstraint?.isActive = true
